  ...
  try {
    ...
    await client.query(`
      INSERT INTO pixpay_services (operator, country, currency, type, service_id, active, notes) VALUES
        ...
        ('ORANGE',   'CI', 'XOF', 'DEPOSIT',    1,   true, 'OM_CI CASH IN'),
        ('ORANGE',   'CI', 'XOF', 'WITHDRAWAL', 2,   true, 'OM_CI CASH OUT'),
        ('MOOV',     'CI', 'XOF', 'DEPOSIT',    3,   true, 'MOOV_CI CASH IN'),
        ('MOOV',     'CI', 'XOF', 'WITHDRAWAL', 4,   true, 'MOOV_CI CASH OUT'),
        ('MTN',      'CI', 'XOF', 'DEPOSIT',    5,   true, 'MTN_CI CASH IN'),
        ('MTN',      'CI', 'XOF', 'WITHDRAWAL', 6,   true, 'MTN_CI CASH OUT'),
        ('WAVE',     'CI', 'XOF', 'DEPOSIT',    7,   true, 'WAVE_CI CASH IN'),
        ('WAVE',     'CI', 'XOF', 'WITHDRAWAL', 8,   true, 'WAVE_CI CASH OUT'),
        -- XOF — Sénégal (SN)
        ('WAVE',     'SN', 'XOF', 'DEPOSIT',    211, true, 'WAVE_SN CASH IN'),
        ('WAVE',     'SN', 'XOF', 'WITHDRAWAL', 210, true, 'WAVE_SN CASH OUT'),
        ('ORANGE',   'SN', 'XOF', 'DEPOSIT',    213, true, 'OM_SN CASH IN'),
        ('ORANGE',   'SN', 'XOF', 'WITHDRAWAL', 214, true, 'OM_SN CASH OUT'),
        ('FREE',     'SN', 'XOF', 'DEPOSIT',    341, true, 'MIX_SN CASH IN'),
        ('FREE',     'SN', 'XOF', 'WITHDRAWAL', 340, true, 'MIX_SN CASH OUT'),
        -- XOF — Burkina Faso (BF)
        ('MOOV',     'BF', 'XOF', 'DEPOSIT',    239, true, 'MOOV_BF CASH IN'),
        ('MOOV',     'BF', 'XOF', 'WITHDRAWAL', 238, true, 'MOOV_BF CASH OUT'),
        ('ORANGE',   'BF', 'XOF', 'DEPOSIT',    241, true, 'ORANGE_BF CASH IN'),
        ('ORANGE',   'BF', 'XOF', 'WITHDRAWAL', 240, true, 'ORANGE_BF CASH OUT'),
        -- XAF — Cameroun (CM)
